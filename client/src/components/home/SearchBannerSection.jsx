        ...
        <div className="bg-white p-4 md:p-6 rounded-2xl shadow-lg border border-gray-100">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-4">
              <button className="flex items-center justify-center gap-2 px-6 py-4 border border-gray-200 rounded-xl hover:bg-gray-50 text-gray-700 font-medium transition-colors">
                <SlidersHorizontal size={18} />
                <span>Filters</span>
              </button>
              <button className="px-8 py-4 bg-[#0F2D52] hover:bg-[#1a3a63] text-white font-bold rounded-xl shadow-md transition-colors whitespace-nowrap">
                Search FindIt
              </button>
            </div>
          </div>
